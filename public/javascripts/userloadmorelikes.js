...
let skip = count;
let loading = false;
const API_URL = window.location.hostname.includes("dev") ? `https://www.img67.com.dev/api/users/${userid}/likes` : `https://www.img67.com/api/users/${userid}/likes`;
