...
let skip = count;
let loading = false;
const API_URL = window.location.hostname.includes("dev") ? `https://www.img67.com.dev/api/topics/${topicid}/followers` : `https://www.img67.com/api/topics/${topicid}/followers`;
